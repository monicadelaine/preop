...
formatMap = {
	...
	#edu.cmu.cs.stage3.alice.core.question.irobot.create.isBumpLeftDepressed : "wooopeeee",
	...
	#Create questions
	edu.cmu.cs.stage3.alice.core.question.irobot.create.IsCasterWheelDropped : "<<<subject>>>'s caster wheel is dropped",
	edu.cmu.cs.stage3.alice.core.question.irobot.create.IsLeftWheelDropped : "<<<subject>>>'s left wheel is dropped",
	edu.cmu.cs.stage3.alice.core.question.irobot.create.IsRightWheelDropped : "<<<subject>>>'s right wheel is dropped",
	edu.cmu.cs.stage3.alice.core.question.irobot.create.IsBumpLeftDepressed : "<<<subject>>>'s left bumper is depressed",
	edu.cmu.cs.stage3.alice.core.question.irobot.create.IsBumpRightDepressed : "<<<subject>>>'s right bumper is depressed",
	edu.cmu.cs.stage3.alice.core.question.irobot.create.IsAdvancePressed : "<<<subject>>>'s advance button is pressed",
	edu.cmu.cs.stage3.alice.core.question.irobot.create.IsPlayPressed : "<<<subject>>>'s play button is pressed",
	edu.cmu.cs.stage3.alice.core.question.irobot.create.IsWallDetected : "<<<subject>>> detects a wall",
	edu.cmu.cs.stage3.alice.core.question.irobot.create.GetXPos : "<<<subject>>>'s X position",
	edu.cmu.cs.stage3.alice.core.question.irobot.create.GetYPos : "<<<subject>>>'s Y position",
	edu.cmu.cs.stage3.alice.core.question.irobot.create.GetTheta : "<<<subject>>>'s theta",
	#Create methods
	edu.cmu.cs.stage3.alice.core.response.irobot.create.MoveAnimation : "<<<subject>>> move <<direction>> <<amount>>",
	edu.cmu.cs.stage3.alice.core.response.irobot.create.ZeroPosition : "<<<subject>>> zero X,Y, and Theta",
	edu.cmu.cs.stage3.alice.core.response.irobot.create.TurnAnimation : "<<<subject>>> turn <<direction>> <<amount>>",
	edu.cmu.cs.stage3.alice.core.response.irobot.create.PlayNote : "<<<subject>>> play note <<note>>",
	edu.cmu.cs.stage3.alice.core.response.irobot.create.PlaySong : "<<<subject>>> play song <<list>>",
	edu.cmu.cs.stage3.alice.core.response.irobot.create.TurnToFaceAnimation : "<<<subject>>> turn to face <<target>>",
	edu.cmu.cs.stage3.alice.core.response.irobot.create.TurnAwayFromAnimation : "<<<subject>>> turn away from <<target>>",
	edu.cmu.cs.stage3.alice.core.response.irobot.create.MoveAtSpeed : "<<<subject>>> move at speed <<direction>> <<speed>>",
	edu.cmu.cs.stage3.alice.core.response.irobot.create.TurnAtSpeed : "<<<subject>>> turn at speed <<direction>> <<speed>>",
	
	#Lego questions
	edu.cmu.cs.stage3.alice.core.question.lego.GetBooleanSensorValue : "<<<subject>>> boolean value of sensor number <<<sensorNum>>>",
	edu.cmu.cs.stage3.alice.core.question.lego.GetNormalizedSensorValue : "<<<subject>>> normalized value of sensor number <<<sensorNum>>>",
	edu.cmu.cs.stage3.alice.core.question.lego.GetRawSensorValue : "<<<subject>>> raw value of sensor number <<<sensorNum>>>",
	edu.cmu.cs.stage3.alice.core.question.lego.GetSensorValue : "<<<subject>>> value of sensor number <<<sensorNum>>>",
	
	#Lego arm methods
	edu.cmu.cs.stage3.alice.core.response.lego.SwivelAnimation : "<<<subject>>> swivel <<direction>><<amount>>",
	edu.cmu.cs.stage3.alice.core.response.lego.ReachAnimation : "<<<subject>>> reach <<direction>><<amount>>",
	edu.cmu.cs.stage3.alice.core.response.lego.OpenClawAnimation : "<<<subject>>> open claw",
	edu.cmu.cs.stage3.alice.core.response.lego.CloseClawAnimation : "<<<subject>>> close claw",
}
