...
public class XML {
    ...
    private static org.w3c.dom.Element encodeElement( edu.cmu.cs.stage3.alice.scenegraph.Element element, org.w3c.dom.Document document, String s, java.util.Dictionary elementsToBeEncoded ) {
		...
		java.util.Enumeration enum = edu.cmu.cs.stage3.alice.scenegraph.Property.getProperties( element.getClass() ).elements();
		while( enum.hasMoreElements() ) {
			edu.cmu.cs.stage3.alice.scenegraph.Property property = (edu.cmu.cs.stage3.alice.scenegraph.Property)enum.nextElement();
	            ...
	            java.io.FileNotFoundException
	{
        ...
        while( true ) {
            ...
            java.util.Enumeration enum = elementsToBeEncoded.keys();
            while( enum.hasMoreElements() ) {
