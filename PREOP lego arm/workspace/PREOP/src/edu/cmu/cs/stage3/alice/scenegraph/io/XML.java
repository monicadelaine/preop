...
public class XML {
    ...
    private static org.w3c.dom.Element encodeElement( edu.cmu.cs.stage3.alice.scenegraph.Element element, org.w3c.dom.Document document, String s, java.util.Dictionary elementsToBeEncoded ) {
		...
		java.util.Enumeration enumeration = edu.cmu.cs.stage3.alice.scenegraph.Property.getProperties( element.getClass() ).elements();
		while( enumeration.hasMoreElements() ) {
			edu.cmu.cs.stage3.alice.scenegraph.Property property = (edu.cmu.cs.stage3.alice.scenegraph.Property)enumeration.nextElement();
	            ...
	            java.io.FileNotFoundException
	{
        ...
        while( true ) {
            ...
            java.util.Enumeration enumeration = elementsToBeEncoded.keys();
            while( enumeration.hasMoreElements() ) {
