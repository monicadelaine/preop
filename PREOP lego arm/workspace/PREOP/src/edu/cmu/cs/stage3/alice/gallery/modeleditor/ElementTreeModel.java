...
class ElementTreeModel implements javax.swing.tree.TreeModel {
	...
	private void fireTreeStructureChanged( Object[] path ) {
		...
		java.util.Enumeration enumeration = m_treeModelListeners.elements();
		while( enumeration.hasMoreElements() ) {
			javax.swing.event.TreeModelListener l = (javax.swing.event.TreeModelListener)enumeration.nextElement();
